...
public class Task
{
    ...
    /*
    * FetchType.LAZY - Task list will not load immediately when the task is fetched
    *       - Task list will be loaded only when taskList property is accessed for the first time.
    ************************/
